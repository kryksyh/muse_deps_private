...
function(wxwidgets_PopulateBuild remote_url local_path os arch build_type)
    message(FATAL_ERROR "[wxwidgets] source build not yet supported (large fork). Use prebuilt.")
endfunction()
...
function(wxwidgets_PopulateSystem)
    ...
    execute_process(COMMAND ${WX_CONFIG} --cxxflags base OUTPUT_VARIABLE wx_cxx OUTPUT_STRIP_TRAILING_WHITESPACE)
    execute_process(COMMAND ${WX_CONFIG} --libs base OUTPUT_VARIABLE wx_libs OUTPUT_STRIP_TRAILING_WHITESPACE)
    ...
    set_property(GLOBAL PROPERTY wxwidgets_INSTALL_LIBRARIES "")
endfunction()
