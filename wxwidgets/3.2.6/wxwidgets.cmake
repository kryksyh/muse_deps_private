...
function(wxwidgets_PopulateBuild remote_url local_path os arch build_type)
    ...
    if (NOT EXISTS "${recipe_dir}/spec.cmake")
        file(DOWNLOAD ${wxwidgets_recipe_base}/wxwidgets/3.2.6/recipe/spec.cmake ${recipe_dir}/spec.cmake)
    endif()
    include("${recipe_dir}/spec.cmake")
    string(TOUPPER ${os} _os)
    foreach(pf ${DEP_PATCHES} ${DEP_PATCHES_${_os}})
        if (NOT EXISTS "${recipe_dir}/${pf}")
            file(DOWNLOAD ${wxwidgets_recipe_base}/wxwidgets/3.2.6/recipe/${pf} ${recipe_dir}/${pf})
        endif()
    endforeach()
